                ...
                <div className="overflow-x-auto rounded-2xl border text-sm w-full">
                    <table className="w-full">
                        ...
                        <tr className="bg-blue-gray-100 text-gray-700">
                            ...
                            <th className="py-3 px-4 text-left hidden lg:table-cell">Average speed</th>
                        ...
                        {lapTimes.data.map(lapTime => (
                            <tr key={lapTime.id} className="border-b border-blue-gray-200 hover:cursor-default">
                                <td className="py-3 px-4" title={lapTime.player_name}>{truncateString(lapTime.player_name)}</td>
                                ...
                                <td className="py-3 px-4 hidden lg:table-cell">{lapTime.average_speed} km/h</td>
                                <td className="py-3 px-4 hidden lg:table-cell">{lapTime.bike.category.name}</td>
