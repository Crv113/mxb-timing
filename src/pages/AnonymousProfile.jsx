...
const AnonymousProfile = () => {
    ...
    if (data?.data?.user_id !== null && data?.data?.user_id !== undefined) {
        navigate(`/profile/${data.data.user_id}`);
        return null;
    }
    ...
    return (
        <>
            ...
            <section className='w-full border-2 border-gray-200 mt-4 rounded-xl p-4'>
                ...
                {player?.best_lap_times?.length > 0
                    ? <BestLapTimesByTrackTable lapTimes={player.best_lap_times} />
